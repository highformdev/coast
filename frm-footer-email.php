...
if(isset($_POST['Contact']) && $_POST['Contact'] == 'submit')
{
    ...
    else
    {
        ...
        $message = '<html><body>';
        $message .= '<div style="width: 4%; padding: 0px 0px 15px 0px" class="py-3"><img style="width: 250px;background-color: #306d6f" src="https://coast.oclakeshore.com/images/header-logo-light.png" alt="" class="footer-logo img-fluid"></div>';
